...
- **雨课堂公告**。登录雨课堂后,课程详情页按时间列出该课公告,课前提醒里也会带上最新一条;
  新公告会单独通知一次(需先登录,可在设置里整体关掉)。
...
- **新公告提醒**:后台每小时(仅联网时)同步一次,有新公告时另发一条通知,点击直达雨课堂设置页。第一次同步某个班级时把已有公告当基线,不会把历史公告当「新公告」推送。
- **可整体关闭**:「设置 → 雨课堂」里有总开关,以及「课前提醒包含最新公告」「后台自动拉取」「新公告提醒」三个分开关,另有「立即刷新公告」。默认全开——没登录时它们本来就是空转的。
